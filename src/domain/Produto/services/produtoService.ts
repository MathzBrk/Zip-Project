import { DadosCadastroProduto, ProductResponse, Produto } from "../entities/produto";
...
import { IProdutoRepository } from "../repositories/interfaces/produtoRepositoryInterface";
